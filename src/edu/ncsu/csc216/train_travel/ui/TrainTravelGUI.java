...
import edu.ncsu.csc216.train_travel.manager.ReservationManager;
import edu.ncsu.csc216.train_travel.manager.TicketMaster;
...
public class TrainTravelGUI extends JFrame implements ActionListener {
    ...
    private DefaultListModel<String> dlmReservations = new DefaultListModel<String>();  // Default list model for reservation display
    private JList<String> lstReservations = new JList<String>(dlmReservations);      // Reservation list to display
